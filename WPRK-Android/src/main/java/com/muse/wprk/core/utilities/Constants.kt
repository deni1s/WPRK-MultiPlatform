...
object Constants {
    ...
    const val TRANSISTOR_BASE_URL1 = "http://10.0.2.2:8080/"
    const val TRANSISTOR_KEY = "_UjUTm9oCpI3alNx90W4zw"
    const val LOGO_URL = "https://firebasestorage.googleapis.com/v0/b/wprk-c6825.appspot.com/o/IMG_4018-removebg-preview%403x.png?alt=media&token=2c203484-1186-4b8e-81c7-5a3186d7640d"
}